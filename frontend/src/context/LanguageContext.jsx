...
// Footer
    ...
    belts: isRtl ? "أحزمة" : "Belts",
    wallets: isRtl ? "محافظ" : "Wallets",
    sunglasses: isRtl ? "نظارات شمسية" : "Sunglasses",
    scarves: isRtl ? "أوشحة" : "Scarves",
    watches: isRtl ? "ساعات" : "Watches",
    gloves: isRtl ? "قفازات" : "Gloves",
    unisex: isRtl ? "للجنسين" : "Unisex",
    formal: isRtl ? "رسمي" : "Formal",
    casual: isRtl ? "كاجوال" : "Casual",
    sports: isRtl ? "رياضي" : "Sports",
    heels: isRtl ? "كعب عالي" : "Heels",
    boots: isRtl ? "جزم" : "Boots",
    sandals: isRtl ? "صنادل" : "Sandals",
